...
class Mateor(pygame.sprite.Sprite):
	def __init__(self, pos, groups):
		super().__init__(groups)
		# radnomizing meteor
		meteor_surf = pygame.image.load('../graphics/asteroid.png').convert_alpha()
...
class Score:
	def __init__(self):
		self.font = pygame.font.Font('../graphics/Chopsic.ttf', 50)
...
# background image
background_surf = pygame.image.load('../graphics/background_2.png').convert()
...
while True:
	...
	for event in pygame.event.get():
		...
		if event.type == meteor_timer:
			...
			Mateor((meteor_x_pos, meteor_y_pos), groups = meteor_group)
